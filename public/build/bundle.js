...
const file$5 = "src\\modules\\Footer.svelte";
...
function create_fragment$7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(hr, file$5, 9, 2, 314);
			add_location(div0, file$5, 11, 4, 384);
			add_location(b0, file$5, 15, 6, 475);
			attr_dev(a0, "href", "mailto:" + email);
			add_location(a0, file$5, 16, 6, 496);
			add_location(br, file$5, 16, 42, 532);
			add_location(b1, file$5, 17, 6, 546);
			attr_dev(a1, "href", "https://github.com/ThaUnknown/");
			add_location(a1, file$5, 17, 21, 561);
			add_location(div1, file$5, 14, 4, 462);
			attr_dev(div2, "class", "d-flex w-full justify-content-around pt-20");
			add_location(div2, file$5, 10, 2, 322);
			attr_dev(div3, "class", "container py-20");
			add_location(div3, file$5, 8, 0, 261);
		},
...
const file$4 = "src\\modules\\Transitions.svelte";
...
function create_fragment$6(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$4, 19, 2, 619);
			...
			add_location(div1, file$4, 18, 0, 509);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
class Transitions extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$5, create_fragment$6, safe_not_equal, { page: 2 }, add_css$3);
...
const file$3 = "src\\modules\\Navbar.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "navbar-brand pointer");
			add_location(div0, file$3, 9, 4, 239);
			attr_dev(div1, "class", "nav-link");
			add_location(div1, file$3, 14, 8, 590);
			attr_dev(li0, "class", "nav-item");
			toggle_class(li0, "active", /*page*/ ctx[0] === 'showcase');
			add_location(li0, file$3, 13, 6, 484);
			attr_dev(div2, "class", "nav-link");
			add_location(div2, file$3, 17, 8, 753);
			attr_dev(li1, "class", "nav-item");
			toggle_class(li1, "active", /*page*/ ctx[0] === 'projects');
			add_location(li1, file$3, 16, 6, 647);
			attr_dev(div3, "class", "nav-link");
			add_location(div3, file$3, 20, 8, 866);
			attr_dev(li2, "class", "nav-item");
			add_location(li2, file$3, 19, 6, 810);
			attr_dev(ul, "class", "navbar-nav ml-auto");
			add_location(ul, file$3, 12, 4, 345);
			attr_dev(nav, "class", "navbar px-20");
			add_location(nav, file$3, 7, 2, 180);
		},
		m: function mount(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$2, 61, 2, 1631);
			attr_dev(div1, "class", "font-weight-bold hero-title text-white svelte-3q2osr");
			add_location(div1, file$2, 63, 4, 1679);
			attr_dev(div2, "class", "font-size-24 mb-20");
			add_location(div2, file$2, 64, 4, 1751);
			attr_dev(button0, "class", "btn btn-lg btn-transparent border svelte-3q2osr");
			attr_dev(button0, "type", "button");
			add_location(button0, file$2, 65, 4, 1834);
			attr_dev(button1, "class", "btn btn-lg btn-primary ml-10 svelte-3q2osr");
			attr_dev(button1, "type", "button");
			add_location(button1, file$2, 66, 4, 1965);
			attr_dev(div3, "class", "container content");
			add_location(div3, file$2, 62, 2, 1642);
			attr_dev(div4, "class", "about mb-20 svelte-3q2osr");
			add_location(div4, file$2, 69, 87, 2222);
			attr_dev(a, "class", "w-full d-flex justify-content-center py-20 pointer");
			add_location(a, file$2, 69, 2, 2137);
			attr_dev(section0, "class", "h-full d-flex flex-column justify-content-between hero svelte-3q2osr");
			add_location(section0, file$2, 60, 0, 1538);
			add_location(b0, file$2, 74, 14, 2381);
			add_location(b1, file$2, 74, 45, 2412);
			attr_dev(span, "class", "font-size-12 font-weight-normal");
			add_location(span, file$2, 75, 22, 2507);
			add_location(b2, file$2, 75, 6, 2491);
			add_location(p0, file$2, 73, 4, 2362);
			add_location(b3, file$2, 78, 12, 2618);
			add_location(b4, file$2, 78, 74, 2680);
			add_location(b5, file$2, 78, 116, 2722);
			add_location(b6, file$2, 79, 6, 2787);
			add_location(p1, file$2, 77, 4, 2601);
			add_location(b7, file$2, 81, 20, 2843);
			add_location(p2, file$2, 81, 4, 2827);
			attr_dev(button2, "class", "btn btn-lg btn-transparent border svelte-3q2osr");
			attr_dev(button2, "type", "button");
			add_location(button2, file$2, 83, 6, 2964);
			attr_dev(button3, "class", "btn btn-lg btn-transparent border ml-10 svelte-3q2osr");
			attr_dev(button3, "type", "button");
			add_location(button3, file$2, 84, 6, 3097);
			attr_dev(p3, "class", "pt-20");
			add_location(p3, file$2, 82, 4, 2939);
			attr_dev(div5, "class", "content");
			add_location(div5, file$2, 72, 2, 2335);
			attr_dev(section1, "class", "container font-size-16 mb-20");
			add_location(section1, file$2, 71, 0, 2267);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance_1($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		const THREE = await import('./3d.js').then(function (n) { return n.t; });
		const net = await import('./vanta.net.js');
...
function add_css(target) {
	append_styles(target, "svelte-1wu6l9", ".svelte-1wu6l9{scroll-behavior:smooth}.content-wrapper.svelte-1wu6l9{perspective:400px;transform-style:preserve-3d}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQXBwLnN2ZWx0ZSIsIm1hcHBpbmdzIjoibUhBK0JBIiwibmFtZXMiOltdLCJzb3VyY2VzIjpbIkFwcC5zdmVsdGUiXX0= */");
}
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 17, 2, 436);
			attr_dev(div1, "class", "page-wrapper bg-very-dark svelte-1wu6l9");
			add_location(div1, file, 14, 0, 353);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
